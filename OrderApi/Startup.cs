...
namespace OrderApi
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            var hostname = Environment.GetEnvironmentVariable("SQLSERVER_HOST") ?? "mssqlserver"; //check this
            ...
            services.AddCors(options => //cors- cross origin requests(calls between website domains)
            {
