...
namespace CartApi.Models
{
    ...
    {// This is implementation of context (different from the context which we have created for ProductCatalogAPI)
        ...
        {
            return await _database.KeyDeleteAsync(id); // id is the BuyerId
        }
